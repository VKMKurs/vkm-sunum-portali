(function () {
  ...
  function examClubSlide() {
    return [
      ...
      '<h1 class="title">Sınav pratiği <span class="accent">doğru yorumla değer kazanır.</span></h1>',
  ...
  function homeworkSlide() {
    return [
      ...
      '<h1 class="title">Ödev, sadece verilen bir görev <span class="accent">değildir.</span></h1>',
  ...
  function resourcesSlide() {
    ...
    return [
      ...
      '<h1 class="title">Doğru kaynağı <span class="accent">biz seçeriz.</span></h1>',
      '<p class="lead">Vaditepe Kurs Merkezi, yılların tecrübesiyle test edilmiş, sınava uygun kaynakları öğrencilerine sunar. Konu anlatımı, soru bankası ve deneme kitapları aynı sistemde dengeli kullanılır.</p>',
      bullets(deck.resourceBullets),
      '</div>',
      '<div class="panel panel-pad">',
      photoBlock,
      '<div class="panel-header"><div><div class="panel-sub">Kaynak yaklaşımı</div><h2 class="panel-title">Aynı kaynakta ortak başarı</h2></div><span class="pill">Seçilmiş</span></div>',
